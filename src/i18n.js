...
const resources = {
  en: {
    translation: {
      ...
      "accessibility.body3": "Feedback: We welcome your feedback on the accessibility of our site. If you encounter accessibility barriers, please contact us immediately so we can address the issue."A free workshop led by local legal advocates covering tenant rights, eviction prevention, and emergency rental assistance.",
      ...
      "event_detail.rsvp.success": "Your RSVP is confirmed! We look forward to seeing you there."(Developer Note: The integration below uses Stripe Checkout. In production, listen for the 'checkout.session.completed' webhook event to fulfill the donation and trigger automated thank-you emails.)",
  ...
  es: {
    translation: {
      ...
      "accessibility.body3": "Comentarios: Agradecemos sus comentarios. Contáctenos si encuentra barreras."Un taller gratuito dirigido por defensores legales locales que cubre los derechos de los inquilinos, la prevención de desalojos y más.",
      ...
      "event_detail.rsvp.success": "¡Su asistencia está confirmada! Esperamos verle allí."(Nota para desarrolladores: La integración a continuación utiliza Stripe Checkout. En producción, escuche el evento de webhook 'checkout.session.completed' para cumplir con la donación y activar los correos electrónicos automáticos de agradecimiento.)",
